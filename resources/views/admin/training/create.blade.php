  ...
  <div class="content-wrapper">
    ...
    <div class="container-fluid">
        ...
        <section class="content contentdesign">
          <h3><u>Add Training</u></h3>
          <form action="{{ route('admin.storetraining') }}" method="POST" enctype="multipart/form-data">
            {{csrf_field()}}
            ...
            <div class="form-group{{ $errors->has('elligible') ? ' has-error' : '' }}">
                 ...
                 <input type="text" name="elligible" class="form-control" placeholder="Enter elligible requirement(Ex-SLC,PLUS2">
