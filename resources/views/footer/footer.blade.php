                ...
                <div class="col-lg-3 column">
                    <div class="widget">
                        <div class="about_widget">
                            <div class="logo">
                                <img class="img-fluid" src="{{url('public/images/fusionlogo.png')}}">
                            </div>
                          <div class="footer-address-section">

                               <i class="fas fa-map-marker-alt"></i> balkumari,koteshwor, Nepal
                           </div>
                        <div class="footer-postbox-section">
                           <i class="fas fa-pen-square"></i> GPO Box:8975, Kathmandu, Nepal.
                       </div>
                       <div class="footer-contact-section">
                           <i class="fas fa-phone"></i>5550634, 5555144, 5555180
                       </div>
                    ...
                    <div class="widget">
                        ...
                        <div class="subscribe_widget" style="margin-bottom: 50px">
                            <form>
                                ...
                                <a href="{{ url('/contact') }}" type="submit"><i class="fas fa-paper-plane"></i></a>
                            </form>
                        </div>
